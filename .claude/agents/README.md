...
| [planner](planner.md) | `grok` | Structured Development Plan | No |
...
| **Output** | Research report in chat (repo / external / combined templates in the agent file) |
...
project skills, `INSIGHTS.md`, and architectural constraints. Does not write
code or run shell.
...
| **Output** | Development Plan in chat (Russian): goal, modules, constraints, phases, **Skill routing**, verification plan, open questions |
...
| **Input** | Approved Development Plan (from planner or equivalent) |
| **Output** | Code changes + Implementation Report in chat (Russian): status, plan adherence, paths, skills applied, verification, hand-off |
...
| **Input** | Full approved Development Plan (+ optional Implementation Report) |
...
| **Input** | Scoped paths / plan / post-implementation change set |
...
| **Input** | Approved plan and/or Implementation Report |
