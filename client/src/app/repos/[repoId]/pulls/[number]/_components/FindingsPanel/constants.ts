...
/** Toolbar jump anchors (Blockers / Warnings / Suggestions). */
export const ANCHOR_SEVERITIES = ["CRITICAL", "WARNING", "SUGGESTION"] as const;
export type AnchorSeverity = (typeof ANCHOR_SEVERITIES)[number];
